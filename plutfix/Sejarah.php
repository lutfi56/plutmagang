            ...
            <div class="container mt-2 mb-2">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav ">
                        ...
                        <a class="nav-link nav-link-font" aria-current="page" href="index.html">Beranda</a>
                        </li>
                        <li class="nav-item dropdown">
                        <a class="nav-link mx-2 dropdown-toggle" href="Tentangkami.php" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Tentang Kami</a>
            ...
            <div class="container">
				<div class="row align-items-center h-100">
					<div class="col-10 mx-auto">
						<div class="jumbotron">
							<h2 class="h1-responsive font-weight-bold text-center my-4"><strong>Sejarah</strong></h2>
									...
									<div class="row">
										<div class="col-lg-12">
											...
											<div class="row align-items-start">
												<div class="col">
													<p></p>
													<img src="img/gdngplut.jpg" width="400" height="400" class="d-inline-block align-top" alt="">
													<p></p>
												</div>
												<div class="col">
													<p class="text-sm-start">Warta PLUT Purworejo. PLUT KUMKM merupakan program yang diselenggarakan oleh Kementerian koperasi dan UMKM dalam rangka memberikan jasa layanan konprehensif dan terpadu bagi pengembangan usaha KUMKM. PLUT KUMKM merupakan lembaga yang menyediakan jasa-jasa non financial untuk meningkatkan daya saing, produktivitas, nilai tambah dan kualitas kinerja KUMKM. Pusat Layanan Usaha Terpadu Koperasi Usaha Mikro kecil dan Menengah (PLUT KUMKM).</p>
													<p class="text-sm-start">Kabupaten Purworejo adalah satu dari sekian banyak PLUT KUMKM yang ada di indonesia dan terus memberikan yang terbaik dalam upaya untuk mewujudkan koperasi sehat dan UMKM naik kelas. PLUT KUMKM Kabupaten Purworejo memiliki luas lahan 3.960 m dengan luas bangunan sebesar 568 m. dengan dana yang bersumber dari APBN 2013. Berkedudukan di Jalan Soekarno-Hatta, Unit Rw.IV No. 92, Boro Kulon, Kec. Banyuurip, Kabupaten Purworejo, Jawa Tengah, 54171.</p>
													<p></p>
												</div>
											</div>
											<div class="col">
