            ...
            <div class="container">
				<div class="row align-items-center h-100">
					<div class="col-10 mx-auto">
						<div class="jumbotron">
							<h2 class="h1-responsive font-weight-bold text-center my-4"><strong>Visi & Misi</strong></h2>
							<hr>
								...
								<div class="text-center">
									<div class="row">
										<div class="col-lg-12">
											...
											<div class="col" >
												<h3 class=" my-4"><strong>Misi</strong></h3>
												<ol>
													<li class="text-start">Mewujudkan Kabupaten Purworejo  sebagai kabupaten yang religius dan demokratis;</li>
													<li class="text-start">Mewujudkan Kabupaten Purworejo sebagai gerbang ekonomi utama bagian selatan Provinsi Jawa Tengah yang berbasis pertanian, pariwisata, industri dan perdagangan;</li>
													<li class="text-start">Mewujudkan Kebupaten Purworejo sebagai daerah tujuan wisata unggulan berbasis budaya dan kearifan lokal;</li>
													<li class="text-start">Mewujudkan Kabupaten Purworejo yang unggul di bidang seni, budaya dan olahraga;</li>
													<li class="text-start">Mewujudkan Kabupaten Purworejo sebagai kabupaten yang unggul di bidang pendidikan dan pelayanan kesehatan;</li>
													<li class="text-start">Mewujudkan Kabupaten Purworejo menjadi kabupaten yang memiliki aparatur pemerintahan yang mampu melaksanakan tata kelola pemerintahan yang baik, bersih dan partisipatif yang berorientasi pada optimalisasi pelayanan publik;</li>
													<li class="text-start">Mewujudkan desa di Kabupaten Purworejo sebagai pusat pertumbuhan ekonomi melalui pemberdayaan masyarakat dalam berbagai bidang.</li>
												</ol>
											</div>
											<div class="col">
												<div class="text-center my-4 mb-5">
