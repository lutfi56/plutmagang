						...
						<div class="jumbotron">
							<div class="row">
								<div class="text-center">
									<h2 class="h1-responsive font-weight-bold text-center my-4"><strong>Layanan Pemasaran</strong></h2>
                    				<img src="img/Pemasaran.png" width="450" height="250" class="d-inline-block align-top" alt="">
								</div>
							</div>
										...
										<div class="col-lg-12">
											...
											<div class="col" >
												<div class="col-lg-9 justify-content-center my-5 isi-konten">
													<p></p>
													<p class="text-sm-start"><strong>Konsultan Bidang   :</strong>  Budi Firmanysah, S.Kom</p>
													...
													<ol>
														<li><p class="text-sm-start"><strong>Penyediaan Informasi Pasar</strong></p></li>
														<li><p class="text-sm-start"><strong>Pengembangan Promosi dan Kemitraan</strong></p></li>
														<li><p class="text-sm-start"><strong>Peningkatan Akses Pasar</strong></p></li>
														<li><p class="text-sm-start"><strong>Pemanfaatan Teknologi Informasi (E-Commerce)</strong></p></li>
														<li><p class="text-sm-start"><strong>Pengembangan Database yang terkait Pengembangan Koperasi Usaha Mikro, Kecil dan Menengah</strong></p></li>
													</ol>
													<p></p>
