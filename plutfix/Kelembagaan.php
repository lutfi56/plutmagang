						...
						<div class="jumbotron">
							<div class="row">
								<div class="text-center">
									<h2 class="h1-responsive font-weight-bold text-center my-4"><strong>Layanan Kelembagaan</strong></h2>
									<img src="img/Kelembagaan.png" width="450" height="250" class="d-inline-block align-top" alt="">
								</div>
							</div>
										...
										<div class="col-lg-12">
											...
											<div class="col" >
												<div class="col-lg-9 justify-content-center my-5 isi-konten">
													<p class="text-sm-start"><strong>Konsultan Bidang   :</strong> Ria Gustinawati, SH</p>
													<p class="text-sm-start"><strong>Konsultan Bidang   :</strong> Ria Gustinawati, SH</p>
													...
													<p class="text-sm-start">*Selama Pandemi diterapkan protocol Kesehatan (Silahkan Buat Janji Terlebih Dahulu). </p>
													<p class="text-sm-start"><strong>Aktivitas Pendampingan Yang Dilakukan Oleh bidang layanan Kelembagaan Meliputi    : </strong></p>
													<p class="text-sm-start">Berdasarkan Keputusan deputi Bidang Restrukturisasi Usaha No. 07 Tahun 2019Tentang Petunjuk Teknis Program Pusat Layanan Usaha Terpadu Koperasi, Usaha Mikro , Kecil dan Menengah. Aktifitas bidang Layanan Kelembagaan Meliputi : </p>
													<ol>
														<li class="text-sm-start lh-lg"><strong>Penyuluhan Koperasi</strong></li>
														<li class="text-sm-start lh-lg"><strong>Fasilitasi Pembentukan, Pembubaran, Penggabungan, Pembagian Koperasi</strong></li>
														<li class="text-sm-start lh-lg"><strong>Penataan Organisasi dan Tatalaksana Koperasi</strong></li>
														<li class="text-sm-start lh-lg"><strong>Legalitas Badan</strong></li>
														<li class="text-sm-start lh-lg"><strong>Ijin Usaha Koperasi</strong> </li>
														<li class="text-sm-start lh-lg"><strong>Ijin Usaha UMKM </strong>(Ijin Usaha , Ijin Produk & Sertifikasi)</li>
													</ol>
												</div>
											</div>
											<div class="col">
