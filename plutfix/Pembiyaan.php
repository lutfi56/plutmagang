						...
						<div class="jumbotron">
							<div class="row">
								<div class="text-center">
									<h2 class="h1-responsive font-weight-bold text-center my-4"><strong>Layanan Pembiyaan</strong></h2>
                    				<img src="img/Pembiyaan.png" width="450" height="250" class="d-inline-block align-top" alt="">
								</div>
							</div>
										...
										<div class="col-lg-12">
											...
											<div class="col" >
												<div class="col-lg-9 justify-content-center my-5 isi-konten">
													<p></p>
													<p class="text-sm-start"><strong>Konsultan Bidang   :</strong>  Wartono Taufik Ismail, SE</p>
													...
													<ol>
														<li><p class="text-sm-start"><strong>Perencanaan Bisnis</strong></p></li>
														<li><p class="text-sm-start"><strong>Penyusunan Proposal Pengembangan Usaha</strong></p></li>
														<li><p class="text-sm-start"><strong>Fasilitasi dan Mediasi Akses Ke Lembaga Keuangan dan Berbagai Sumber Pembiayaan</strong></p></li>
														<li><p class="text-sm-start"><strong>Manajemen Keuangan</strong></p></li>
													</ol>
													<p></p>
