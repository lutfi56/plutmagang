						...
						<div class="jumbotron">
							<div class="row">
								<div class="text-center">
									<h2 class="h1-responsive font-weight-bold text-center my-4"><strong>Layanan Produksi</strong></h2>
                    				<img src="img/Produksi.png" width="450" height="250" class="d-inline-block align-top" alt="">
								</div>
							</div>
										...
										<div class="col-lg-12">
											...
											<div class="col" >
												<div class="col-lg-9 justify-content-center my-5 isi-konten">
													<p></p>
													<p class="text-sm-start"><strong>Konsultan Bidang   :</strong>  Achmad Paris Ridwan, Sei</p>
													<p class="text-sm-start"><strong>BNSP  :</strong>  Pendamping UMKM</p>
													<br>
													...
													<p class="text-sm-start lh-lg"><strong> Aktivitas Pendampingan Yang Dilakukan Oleh bidang layanan Kelembagaan Meliputi    :</strong></p>
													<p class="text-sm-start lh-lg">Berdasarkan Keputusan deputi Bidang Restrukturisasi Usaha No. 07 Tahun 2019 Tentang Petunjuk Teknis Program Pusat Layanan Usaha Terpadu Koperasi, Usaha Mikro , Kecil dan Menengah. Aktifitas bidang Layanan Pembiayaan Meliputi :</p>
													<ol>
														<li><p class="text-sm-start"><strong>Akses Bahan Baku</strong></p></li>
														<li><p class="text-sm-start"><strong>Pengolahan Produk</strong></p></li>
														<li><p class="text-sm-start"><strong>Pemanfaatan Teknologi Pengolahan</strong></p></li>
														<li><p class="text-sm-start"><strong>Standarisasi dan Sertifikasi Produk</strong></p></li>
														<li><p class="text-sm-start"><strong>Pelebelan dan Pengemasan</strong></p></li>
													</ol>
													<p class="text-sm-start">Untuk membantu layanan bidang produksi , Maka Layanan PLUT KUMKM Kabupaten Cianjur Memiliki Assisten (Pendamping) Bidang Produksi Sebanyak 1 Orang, Yakni :</p>
													<p class="text-sm-start"><strong>Konsultan Bidang   :</strong>  Dian Sudiana Raflan, M.Pd</p>
													<p class="text-sm-start"><strong>BNSP  :</strong> -  </p><br>
													<p class="text-sm-start"><strong>Jam Layanan     :</strong> Pukul 09.00 – 15.00 WIB. Setiap Jam Kerja ( Silahkan Buat Janji Terlebih Dahulu). </p>
													<p class="text-sm-start">*Selama Pandemi diterapkan protocol Kesehatan (Silahkan Buat Janji Terlebih Dahulu).</p><br>
													<p class="text-sm-start"><strong> Aktivitas Pendampingan Yang Dilakukan   : </strong></p>
													<ol>
														<li><p class="text-sm-start">Qualiti Control / manajemen mutu</p></li>
														<li><p class="text-sm-start">Pengemasan</p></li>
													</ol>
